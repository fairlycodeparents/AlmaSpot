...
- Results page: A dynamic page that displays search results.
- Assistant page: A chat-based interface where students can interact with the AI assistant to refine their
...
- Filter panel: A pop-up panel that allows students and administrators to apply filters to their search, such as
