...
| **Activity**     | It occupies a *Period* in a specific *Room*. Can be: <br/> 1. **Lecture**: <br/>a planned academic activity imported from the official schedule. <br/> 2. **Seminar** (or Exception): a non-academic activity.                    | Core         |
