...
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------|
| **Assistant**     | The conversational component of the system that interprets natural language queries to discover (compound) *Solutions* when a direct search fails.                                                                                                                                 | Assistant    |
| **Request**       | A natural language input provided by the *Student* describing their study needs.                                                                                                                                                                                                   | Assistant    |
| **Suggestion**    | The answer generated by the *Assistant*, containing a proposed *Solution* when possible, otherwise requests a refinement of the search parameters.                                                                                                                                 | Assistant    |
| **Solution**      | The result provided to the *Student* in response to a request. It can be a simple solution (a single *Slot*) or, if unavailable, a compound solution generated by a *Assistant* (multiple *Slots*).                                                                                | Assistant    |
| **User**          | A person that uses the system. <br/> 1. **Student**. <br/> 2. **Admin**.                                                                                                                                                                                                           | Core         |
| **Room**          | A physical spatial unit identified by a name and a *Site*. Can be: <br/> 1. **Laboratory**. <br/> 2. **Class**.                                                                                                                                                                    | Core         |
| **Period**        | A specific start-time and end-time interval.                                                                                                                                                                                                                                       | Core         |
| **Event**         | It occupies a *Period* in a specific *Room*. Can be: <br/> 1. **Academic Event**: a planned academic activity (lecture or exam) imported from the official schedule. <br/> 2. **External Event** (or Exception): a non-academic activity (such as seminars or S.P.R.I.Te. events). | Core         |
| **Slot**          | A *Period* available for use in a *Room*.                                                                                                                                                                                                                                          | Core         |
| **Plan**          | A user-defined selection of one or more *Slot*s.                                                                                                                                                                                                                                   | Core         |
