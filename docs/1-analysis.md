...
| **Suggestion**   | The answer generated by the _Assistant_, containing a proposed _Solution_ when possible, otherwise requests a refinement of the search parameters.                                                                                                                                      | Search                     |
| **Solution**     | The result provided to the _Student_ in response to a request. It can be a simple solution (a single _Slot_) or, if unavailable, a compound solution generated by a _Assistant_ (multiple _Slots_).                                                                                     | Search                     |
